...
final class ArticleControllerTest extends WebTestCase
{
    ...
    private string $path = '/article/crud/';
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'article[dateCreate]' => 'Testing',
            'article[datePublish]' => 'Testing',
    ...
    public function testShow(): void
    {
        ...
        $fixture->setDatePublish('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'article[dateCreate]' => 'Something New',
            'article[datePublish]' => 'Something New',
            'article[isPublished]' => 'Something New',
        ]);

        self::assertResponseRedirects('/article/crud/');
        ...
        self::assertSame('Something New', $fixture[0]->getDatePublish());
